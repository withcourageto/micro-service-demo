package top.cmoon.micoservice.blog.blogservice.service.security;
...
@Deprecated
public class CustomUserInfoTokenServices1 implements ResourceServerTokenServices {
	...
	public CustomUserInfoTokenServices1(String userInfoEndpointUrl, String clientId) {
